...
class Encounter(val zone: Zone, val level: Int, val progression: Int, val isBoss: Boolean, val seed: Long)
{
	...
	fun generateRewards(victory: Boolean): Array<RewardDesc>
	{
		...
		expAmountTable.add(Label(expReward.prettyPrint(), Statics.skin, "small")).padBottom(5f)
		...
		goldAmountTable.add(Label(goldReward.prettyPrint(), Statics.skin, "small")).padBottom(5f)
